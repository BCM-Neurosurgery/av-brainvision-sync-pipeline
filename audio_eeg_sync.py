...
if __name__ == "__main__":
    ...
    bv_start_time, exp_start_time, exp_end_time, bv_sync_pulse_array = parse_brainvision(vhdr_path_object=vhdr_path_obj)

    # get the sync pulses from the audio file
    audio_file_start, audio_sfreq, audio_sync_pulse_array, stitched_voltages_pulses, stitched_voltages_raw= parse_audio(audio_path_object=audio_path_obj)
    ...
    if run_waveform_beep_matching: 
        ...
        predicted_matched_beep_time = beep_matching(voltages_raw=stitched_voltages_raw, audio_sfreq=audio_sfreq, beep_file=prt_paat_beep_path,
